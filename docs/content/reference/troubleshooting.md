...
Most of these come down to network reality or how opennotify serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

opennotify rate-limits like any public site. opennotify already paces
...
Where a surface is gated, opennotify reads a cookie or token you supply
...
`opennotify`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what opennotify actually did
