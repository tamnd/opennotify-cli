...
// HTTP behaviour is covered in opennotify_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "opennotify://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("opennotify", "about")
	if err != nil || got.String() != "opennotify://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want opennotify://page/about", got.String(), err)
	}
}
