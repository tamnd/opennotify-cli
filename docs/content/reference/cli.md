...
```
opennotify <command> [arguments] [flags]
```

Run `opennotify <command> --help` for the full flag list on any command. This
...
per operation you declare in `opennotify/domain.go`.
